...
<body>
  ...
  <main id="content" tabindex="-1" aria-busy="true">
    ...
    <section id="run-detail" class="hidden" aria-labelledby="detail-heading">
      ...
      <p class="timeline-note">Width encodes elapsed time; each block shows exact duration.</p>
      <ol id="timeline" class="phase-timeline" aria-labelledby="timeline-heading"></ol>
      <section id="segment-detail" class="segment-detail"></section>
      <details class="raw-events"><summary>Event log</summary><ol id="events" class="timeline"></ol></details>
    </section>
